...
if is_available "toggleterm.nvim" then
  ...
  if vim.fn.executable "gdu" == 1 then
    maps.n["<leader>tu"] = { function() utilt.toggle_term_cmd "gdu" end, desc = "ToggleTerm gdu" }
  end
  ...
  maps.n["<leader>th"] = { "<cmd>ToggleTerm size=20 direction=horizontal<cr>", desc = "ToggleTerm horizontal split" }
  maps.n["tt"] = maps.n["<leader>th"]
  maps.n["<leader>tv"] = { "<cmd>ToggleTerm size=80 direction=vertical<cr>", desc = "ToggleTerm vertical split" }
  maps.n["<F7>"] = { "<cmd>ToggleTerm<cr>", desc = "Toggle terminal" }
  maps.t["<F7>"] = maps.n["<F7>"]
  maps.n["<C-'>"] = maps.n["<F7>"] -- requires terminal that supports binding <C-'>
  maps.t["<C-'>"] = maps.n["<F7>"] -- requires terminal that supports binding <C-'>
  maps.t["<esc>"] = { "<C-\\><C-n>", desc = "Leave terminal" }
end
